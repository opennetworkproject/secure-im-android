...
import com.opennetwork.secureim.components.ContactFilterToolbar;
import com.opennetwork.secureim.components.ContactFilterToolbar.OnFilterChangedListener;
...
public class InviteActivity extends PassphraseRequiredActionBarActivity implements ContactSelectionListFragment.OnContactSelectedListener {
  ...
  private void initializeResources() {
    ...
    inviteText.setText(getString(R.string.InviteActivity_lets_switch_to_opennetwork, "https://sgnl.link/1KpeYmF"));
    updateSmsButtonText();
  ...
  private class ShareClickListener implements OnClickListener {
    ...
    public void onClick(View v) {
      ...
      if (sendIntent.resolveActivity(getPackageManager()) != null) {
        startActivity(Intent.createChooser(sendIntent, getString(R.string.InviteActivity_invite_to_opennetwork)));
      } else {

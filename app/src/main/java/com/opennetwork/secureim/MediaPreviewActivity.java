...
import com.opennetwork.secureim.components.ZoomingImageView;
...
import com.opennetwork.secureim.video.VideoPlayer;
  ...
  private void saveToDisk() {
    SaveAttachmentTask.showWarningDialog(this, (dialogInterface, i) -> {
      Permissions.with(this)
                 ...
                 .ifNecessary()
                 .withPermanentDenialDialog(getString(R.string.MediaPreviewActivity_opennetwork_needs_the_storage_permission_in_order_to_write_to_external_storage_but_it_has_been_permanently_denied))

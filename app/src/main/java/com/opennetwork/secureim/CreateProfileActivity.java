...
import com.opennetwork.secureim.components.emoji.EmojiToggle;
...
import com.opennetwork.secureim.profiles.ProfileMediaConstraints;
import com.opennetwork.secureim.profiles.SystemProfileUtil;
...
import com.opennetwork.secureim.util.FileProviderUtil;
import com.opennetwork.secureim.util.IntentUtils;
...
import com.opennetwork.imservice.api.util.StreamDetails;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  @Inject OpenNetworkServiceAccountManager accountManager;
  ...
  private void initializeResources() {
    ...
    informationLabel.setOnClickListener(view -> {
      ...
      intent.setData(Uri.parse("https://support.opennetwork.org/hc/en-us/articles/115001434171"));
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("com.opennetwork.securesms.action.CLEAR_PROFILE_PHOTO"));
    }

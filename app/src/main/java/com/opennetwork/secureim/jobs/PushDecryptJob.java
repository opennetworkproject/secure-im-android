...
import com.opennetwork.secureim.attachments.DatabaseAttachment;
import com.opennetwork.secureim.attachments.PointerAttachment;
...
import com.opennetwork.secureim.database.MessagingDatabase;
...
import com.opennetwork.secureim.groups.GroupMessageProcessor;
...
import com.opennetwork.secureim.sms.IncomingEncryptedMessage;
import com.opennetwork.secureim.sms.IncomingEndSessionMessage;
import com.opennetwork.secureim.sms.IncomingPreKeyBundleMessage;
...
import com.opennetwork.libim.UntrustedIdentityException;
import com.opennetwork.libim.protocol.PreKeyOpenNetworkMessage;
...
import com.opennetwork.imservice.api.crypto.OpenNetworkServiceCipher;
import com.opennetwork.imservice.api.messages.OpenNetworkServiceAttachment;
import com.opennetwork.imservice.api.messages.OpenNetworkServiceContent;
...
import com.opennetwork.imservice.api.messages.multidevice.RequestMessage;
import com.opennetwork.imservice.api.messages.multidevice.SentTranscriptMessage;
...
public class PushDecryptJob extends ContextJob {
  ...
  public void onRun() throws NoSuchMessageException {
    ...
    OpenNetworkServiceEnvelope envelope             = database.get(messageId);
  ...
  private void handleMessage(MasterSecretUnion masterSecret, OpenNetworkServiceEnvelope envelope, Optional<Long> smsMessageId) {
    try {
      GroupDatabase        groupDatabase = DatabaseFactory.getGroupDatabase(context);
      OpenNetworkProtocolStore  axolotlStore  = new OpenNetworkProtocolStoreImpl(context);
      OpenNetworkServiceAddress localAddress  = new OpenNetworkServiceAddress(TextSecurePreferences.getLocalNumber(context));
      OpenNetworkServiceCipher  cipher        = new OpenNetworkServiceCipher(localAddress, axolotlStore);

      OpenNetworkServiceContent content = cipher.decrypt(envelope);

      if (content.getDataMessage().isPresent()) {
        OpenNetworkServiceDataMessage message = content.getDataMessage().get();
        ...
        OpenNetworkServiceSyncMessage syncMessage = content.getSyncMessage().get();
        ...
        OpenNetworkServiceCallMessage message = content.getCallMessage().get();
        ...
        OpenNetworkServiceReceiptMessage message = content.getReceiptMessage().get();
      ...
      if (envelope.isPreKeyOpenNetworkMessage()) {
  ...
  private void handleCallOfferMessage(@NonNull OpenNetworkServiceEnvelope envelope,
  ...
  private void handleCallAnswerMessage(@NonNull OpenNetworkServiceEnvelope envelope,
  ...
  private void handleCallIceUpdateMessage(@NonNull OpenNetworkServiceEnvelope envelope,
  ...
  private void handleCallHangupMessage(@NonNull OpenNetworkServiceEnvelope envelope,
  ...
  private void handleCallBusyMessage(@NonNull OpenNetworkServiceEnvelope envelope,
                                       ...
                                       @NonNull Optional<Long>           smsMessageId)
  {
    ...
    IncomingTextMessage   incomingTextMessage = new IncomingTextMessage(Address.fromExternal(context, envelope.getSource()),
                                                                        ...
                                                                        "", Optional.<OpenNetworkServiceGroup>absent(), 0);
  ...
  private void handleUnknownGroupMessage(@NonNull OpenNetworkServiceEnvelope envelope,
      ...
      throws MmsException
  {
    ...
    IncomingMediaMessage mediaMessage = new IncomingMediaMessage(masterSecret,
                                                                 ...
                                                                 Optional.<List<OpenNetworkServiceAttachment>>absent());
...
//    }
                                              ...
                                              @NonNull Optional<Long> smsMessageId)
  {
    try {
      ...
      PreKeyOpenNetworkMessage   chatMessage    = new PreKeyOpenNetworkMessage(serialized);
  ...
  private void handleProfileKey(@NonNull OpenNetworkServiceEnvelope envelope,
                                @NonNull OpenNetworkServiceDataMessage message)
  {
  ...
  private void handleDeliveryReceipt(@NonNull OpenNetworkServiceEnvelope envelope,
                                     @NonNull OpenNetworkServiceReceiptMessage message)
  {
  ...
  private void handleReadReceipt(@NonNull OpenNetworkServiceEnvelope envelope,
                                 @NonNull OpenNetworkServiceReceiptMessage message)
  {
  ...
  private Optional<InsertResult> insertPlaceholder(@NonNull OpenNetworkServiceEnvelope envelope) {
    EncryptingSmsDatabase database    = DatabaseFactory.getEncryptingSmsDatabase(context);
    IncomingTextMessage   textMessage = new IncomingTextMessage(Address.fromExternal(context, envelope.getSource()),
                                                                envelope.getSourceDevice(),
  ...
  private Recipient getMessageDestination(OpenNetworkServiceEnvelope envelope, OpenNetworkServiceDataMessage message) {

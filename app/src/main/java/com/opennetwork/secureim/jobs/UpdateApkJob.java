...
import com.opennetwork.secureim.service.UpdateApkReadyListener;
import com.opennetwork.secureim.util.FileUtils;
...
public class UpdateApkJob extends ContextJob {
  ...
  private void handleDownloadStart(String uri, String versionName, byte[] digest) {
    ...
    downloadRequest.setTitle("Downloading OpenNetwork update");
    downloadRequest.setDescription("Downloading OpenNetwork " + versionName);
    downloadRequest.setVisibleInDownloadsUi(false);
    downloadRequest.setDestinationInExternalFilesDir(context, null, "opennetwork-update.apk");

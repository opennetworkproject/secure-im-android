...
public class DeviceProvisioningActivity extends PassphraseRequiredActionBarActivity {
  ...
  protected void onCreate(Bundle bundle, @NonNull MasterSecret masterSecret) {
    ...
    AlertDialog dialog = new AlertDialog.Builder(this)
        .setTitle(getString(R.string.DeviceProvisioningActivity_link_a_opennetwork_device))
        .setMessage(getString(R.string.DeviceProvisioningActivity_it_looks_like_youre_trying_to_link_a_opennetwork_device_using_a_3rd_party_scanner))

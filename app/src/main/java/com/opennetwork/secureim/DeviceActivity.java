...
import com.opennetwork.libim.ecc.ECPublicKey;
import com.opennetwork.libim.util.guava.Optional;
import com.opennetwork.imservice.api.OpenNetworkServiceAccountManager;
import com.opennetwork.imservice.api.push.exceptions.NotFoundException;
import com.opennetwork.imservice.internal.push.DeviceLimitExceededException;
    ...
    implements Button.OnClickListener, ScanListener, DeviceLinkFragment.LinkClickedListener
{
  ...
  public void onClick(View v) {
    Permissions.with(this)
               ...
               .ifNecessary()
               .withPermanentDenialDialog(getString(R.string.DeviceActivity_opennetwork_needs_the_camera_permission_in_order_to_scan_a_qr_code))
               .onAllGranted(() -> {

...
import com.opennetwork.secureim.sms.IncomingJoinedMessage;
import com.opennetwork.libim.util.guava.Optional;
import com.opennetwork.imservice.api.OpenNetworkServiceAccountManager;
import com.opennetwork.imservice.api.push.ContactTokenDetails;
...
public class DirectoryHelper {
  ...
  private static @NonNull List<Address> refreshDirectory(@NonNull Context context, @NonNull OpenNetworkServiceAccountManager accountManager)
      throws IOException
  {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("com.opennetwork.securesms");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "com.opennetwork.securesms");

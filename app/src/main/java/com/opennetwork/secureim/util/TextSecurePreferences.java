...
public class TextSecurePreferences {
  ...
  private static final String opennetworkING_KEY_PREF               = "pref_opennetworking_key";
  ...
  public static void setOpenNetworkingKey(Context context, String opennetworkingKey) {
    setStringPreference(context, opennetworkING_KEY_PREF, opennetworkingKey);
  }

  public static String getOpenNetworkingKey(Context context) {
    return getStringPreference(context, opennetworkING_KEY_PREF, null);
  }

...
import com.opennetwork.secureim.util.CharacterCalculator;
import com.opennetwork.secureim.util.MmsCharacterCalculator;
import com.opennetwork.secureim.permissions.Permissions;
import com.opennetwork.secureim.util.PushCharacterCalculator;
import com.opennetwork.secureim.util.SmsCharacterCalculator;
...
public class TransportOptions {
  ...
  private List<TransportOption> initializeAvailableTransports(boolean isMediaMessage) {
    ...
    results.add(new TransportOption(Type.TEXTSECURE, R.drawable.ic_send_push_white_24dp,
                                    ...
                                    context.getString(R.string.ConversationActivity_transport_opennetwork),

...
import com.opennetwork.secureim.components.RatingManager;
import com.opennetwork.secureim.components.SearchToolbar;
...
import com.opennetwork.secureim.util.DynamicNoActionBarTheme;
    ...
    implements ConversationListFragment.ConversationSelectedListener
{
  ...
  private void initializeSearchListener() {
    searchAction.setOnClickListener(v -> {
      Permissions.with(this)
                 ...
                 .withPermanentDenialDialog(getString(R.string.ConversationListActivity_opennetwork_needs_contacts_permission_in_order_to_search_your_contacts_but_it_has_been_permanently_denied))
                 .execute();
    });
  ...
  private void handleHelp() {
    try {
      startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://support.opennetwork.co")));

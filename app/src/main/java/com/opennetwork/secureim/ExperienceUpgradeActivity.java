...
import com.opennetwork.secureim.IntroPagerAdapter.IntroPage;
...
public class ExperienceUpgradeActivity extends BaseActionBarActivity {
  ...
  private static final String DISMISS_ACTION  = "com.opennetwork.securesms.ExperienceUpgradeActivity.DISMISS_ACTION";
  private static final int    NOTIFICATION_ID = 1339;

  private enum ExperienceUpgrade {
    opennetwork_REBRANDING(157,
                      new IntroPage(0xFF2090EA,
                                    BasicIntroFragment.newInstance(R.drawable.splash_logo,
                                                                   R.string.ExperienceUpgradeActivity_welcome_to_opennetwork_dgaf,
                                                                   R.string.ExperienceUpgradeActivity_textsecure_is_now_called_opennetwork)),
                      R.string.ExperienceUpgradeActivity_welcome_to_opennetwork_excited,
                      R.string.ExperienceUpgradeActivity_textsecure_is_now_opennetwork,
                      R.string.ExperienceUpgradeActivity_textsecure_is_now_opennetwork_long,
                      null),
    VIDEO_CALLS(245,
                      new IntroPage(0xFF2090EA,
                                    BasicIntroFragment.newInstance(R.drawable.video_splash,
                                                                   R.string.ExperienceUpgradeActivity_say_hello_to_video_calls,
                                                                   R.string.ExperienceUpgradeActivity_opennetwork_now_supports_secure_video_calls)),
                      R.string.ExperienceUpgradeActivity_say_hello_to_video_calls,
                      R.string.ExperienceUpgradeActivity_opennetwork_now_supports_secure_video_calling,
                      R.string.ExperienceUpgradeActivity_opennetwork_now_supports_secure_video_calling_long,
                null),
    PROFILES(286,
                 new IntroPage(0xFF2090EA,
                               BasicIntroFragment.newInstance(R.drawable.profile_splash,
                                                              R.string.ExperienceUpgradeActivity_ready_for_your_closeup,
                                                              R.string.ExperienceUpgradeActivity_now_you_can_share_a_profile_photo_and_name_with_friends_on_opennetwork)),
             R.string.ExperienceUpgradeActivity_opennetwork_profiles_are_here,
             R.string.ExperienceUpgradeActivity_now_you_can_share_a_profile_photo_and_name_with_friends_on_opennetwork,
             R.string.ExperienceUpgradeActivity_now_you_can_share_a_profile_photo_and_name_with_friends_on_opennetwork,
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setStatusBarColor(getResources().getColor(R.color.opennetwork_primary_dark));
    ...
    public void onReceive(Context context, Intent intent) {
          ...
          intent.getData().getSchemeSpecificPart().equals(context.getPackageName()))
      {
        ...
        Notification notification = new NotificationCompat.Builder(context)
                                        ...
                                        .setColor(context.getResources().getColor(R.color.opennetwork_primary))

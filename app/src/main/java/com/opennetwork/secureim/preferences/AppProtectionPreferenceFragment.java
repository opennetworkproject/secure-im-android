...
import com.opennetwork.secureim.BlockedContactsActivity;
import com.opennetwork.secureim.PassphraseChangeActivity;
  ...
  private class DisablePassphraseClickListener implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(final Preference preference, Object newValue) {
      if (((CheckBoxPreference)preference).isChecked()) {
        ...
        builder.setMessage(R.string.ApplicationPreferencesActivity_this_will_permanently_unlock_opennetwork_and_message_notifications);

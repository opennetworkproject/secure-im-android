...
import com.opennetwork.secureim.ApplicationPreferencesActivity;
import com.opennetwork.secureim.LogSubmitActivity;
...
import com.opennetwork.secureim.contacts.ContactIdentityManager;
...
import com.opennetwork.imservice.api.push.exceptions.AuthorizationFailedException;
  ...
  private class PushMessagingClickListener implements Preference.OnPreferenceChangeListener {
    ...
    private class DisablePushMessagesTask extends ProgressDialogAsyncTask<Void, Void, Integer> {
      ...
      public DisablePushMessagesTask(final CheckBoxPreference checkBoxPreference) {
        super(getActivity(), R.string.ApplicationPreferencesActivity_unregistering, R.string.ApplicationPreferencesActivity_unregistering_from_opennetwork_messages_and_calls);
      ...
      protected Integer doInBackground(Void... params) {
        try {
          ...
          OpenNetworkServiceAccountManager accountManager = AccountManagerFactory.createManager(context);
    ...
    public boolean onPreferenceChange(final Preference preference, Object newValue) {
      if (((CheckBoxPreference)preference).isChecked()) {
        ...
        builder.setTitle(R.string.ApplicationPreferencesActivity_disable_opennetwork_messages_and_calls);
        builder.setMessage(R.string.ApplicationPreferencesActivity_disable_opennetwork_messages_and_calls_by_unregistering);

...
import com.opennetwork.secureim.components.RecyclerViewFastScroller.FastScrollAdapter;
import com.opennetwork.secureim.contacts.ContactSelectionListAdapter.HeaderViewHolder;
import com.opennetwork.secureim.contacts.ContactSelectionListAdapter.ViewHolder;
import com.opennetwork.secureim.database.CursorRecyclerViewAdapter;
import com.opennetwork.secureim.mms.GlideRequests;
import com.opennetwork.secureim.util.StickyHeaderDecoration.StickyHeaderAdapter;
                                                    ...
                                                    StickyHeaderAdapter<HeaderViewHolder>
{
  ...
  private CharSequence getSpannedHeaderString(int position) {
    ...
    if (isPush(position)) {
      ...
      spannable.setSpan(new ForegroundColorSpan(getContext().getResources().getColor(R.color.opennetwork_primary)), 0, headerString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
      return spannable;
    } else {
      return headerString;
    }

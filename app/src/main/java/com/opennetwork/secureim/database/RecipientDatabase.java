...
public class RecipientDatabase extends Database {
  ...
  private static final String opennetwork_PROFILE_NAME     = "opennetwork_profile_name";
  private static final String opennetwork_PROFILE_AVATAR   = "opennetwork_profile_avatar";
  ...
  private static final String[] RECIPIENT_PROJECTION = new String[] {
      ...
      opennetwork_PROFILE_NAME, opennetwork_PROFILE_AVATAR, PROFILE_SHARING
  };
  ...
  public static final String CREATE_TABLE =
      "CREATE TABLE " + TABLE_NAME +
          ...
          opennetwork_PROFILE_NAME + " TEXT DEFAULT NULL, " +
          opennetwork_PROFILE_AVATAR + " TEXT DEFAULT NULL, " +
  ...
  Optional<RecipientSettings> getRecipientSettings(@NonNull Cursor cursor) {
    ...
    String  opennetworkProfileName     = cursor.getString(cursor.getColumnIndexOrThrow(opennetwork_PROFILE_NAME));
    String  opennetworkProfileAvatar   = cursor.getString(cursor.getColumnIndexOrThrow(opennetwork_PROFILE_AVATAR));
    ...
    return Optional.of(new RecipientSettings(blocked, muteUntil,
                                             ...
                                             opennetworkProfileName, opennetworkProfileAvatar, profileSharing));
  }
  ...
  public void setProfileName(@NonNull Recipient recipient, @Nullable String profileName) {
    ContentValues contentValues = new ContentValues(1);
    contentValues.put(opennetwork_PROFILE_NAME, profileName);
  ...
  public void setProfileAvatar(@NonNull Recipient recipient, @Nullable String profileAvatar) {
    ContentValues contentValues = new ContentValues(1);
    contentValues.put(opennetwork_PROFILE_AVATAR, profileAvatar);
    updateOrInsert(recipient.getAddress(), contentValues);
  ...
  public static class RecipientSettings {
    ...
    private final String          opennetworkProfileName;
    private final String          opennetworkProfileAvatar;
    ...
    RecipientSettings(boolean blocked, long muteUntil,
                      ...
                      @Nullable String opennetworkProfileName,
                      @Nullable String opennetworkProfileAvatar,
                      boolean profileSharing)
    {
      ...
      this.opennetworkProfileName     = opennetworkProfileName;
      this.opennetworkProfileAvatar   = opennetworkProfileAvatar;
    ...
    public @Nullable String getProfileName() {
      return opennetworkProfileName;
    }

    public @Nullable String getProfileAvatar() {
      return opennetworkProfileAvatar;
    }

...
public class PushDatabase extends Database {
  ...
  public long insert(@NonNull OpenNetworkServiceEnvelope envelope) {
  ...
  public OpenNetworkServiceEnvelope get(long id) throws NoSuchMessageException {
    Cursor cursor = null;
    ...
    try {
      ...
      if (cursor != null && cursor.moveToNext()) {
        ...
        return new OpenNetworkServiceEnvelope(cursor.getInt(cursor.getColumnIndexOrThrow(TYPE)),
  ...
  private Optional<Long> find(OpenNetworkServiceEnvelope envelope) {
  ...
  public static class Reader {
    ...
    public OpenNetworkServiceEnvelope getNext() {
      try {
        if (cursor == null || !cursor.moveToNext())
          return null;
        ...
        return new OpenNetworkServiceEnvelope(type, source, deviceId, "", timestamp,

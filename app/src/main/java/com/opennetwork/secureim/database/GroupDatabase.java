...
public class GroupDatabase extends Database {
  ...
  public void create(@NonNull String groupId, @Nullable String title, @NonNull List<Address> members,
                     @Nullable OpenNetworkServiceAttachmentPointer avatar, @Nullable String relay)
  {
    Collections.sort(members);
  ...
  public void update(String groupId, String title, OpenNetworkServiceAttachmentPointer avatar) {
    ContentValues contentValues = new ContentValues();

...
import com.opennetwork.secureim.contacts.ContactsDatabase;
import com.opennetwork.secureim.crypto.DecryptingPartInputStream;
...
import com.opennetwork.secureim.util.DelimiterUtil;
...
//    DecryptingQueue.schedulePendingDecrypts(context, masterSecret);
  ...
  private static class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      ...
      if (oldVersion < NO_MORE_RECIPIENTS_PLURAL) {
        ...
        while (cursor != null && cursor.moveToNext()) {
          ...
          if (addressList.length == 1) {
            ...
            String        encodedGroupId = "__opennetwork_mms_group__!" + Hex.toStringCondensed(groupId);
      ...
      if (oldVersion < PROFILES) {
        ...
        db.execSQL("ALTER TABLE recipient_preferences ADD COLUMN opennetwork_profile_name TEXT DEFAULT NULL");
        db.execSQL("ALTER TABLE recipient_preferences ADD COLUMN opennetwork_profile_avatar TEXT DEFAULT NULL");
      }
  ...
  private static class OldDirectoryDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME    = "opennetwork_directory.db";

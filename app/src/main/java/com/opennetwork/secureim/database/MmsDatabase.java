...
import com.opennetwork.secureim.attachments.MmsNotificationAttachment;
...
import com.opennetwork.secureim.database.documents.IdentityKeyMismatchList;
import com.opennetwork.secureim.database.documents.NetworkFailure;
import com.opennetwork.secureim.database.documents.NetworkFailureList;
import com.opennetwork.secureim.database.model.DisplayRecord;
...
import com.opennetwork.secureim.database.model.NotificationMmsMessageRecord;
import com.opennetwork.secureim.jobs.TrimThreadJob;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (com.opennetwork.secureim.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = com.opennetwork.secureim.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = com.opennetwork.secureim.util.Util.toIsoBytes(transactionId);

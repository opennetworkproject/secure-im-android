...
public class OpenNetworkMapView extends LinearLayout {

  private MapView   mapView;
  private ImageView imageView;
  private TextView  textView;

  public OpenNetworkMapView(Context context) {
    this(context, null);
  }

  public OpenNetworkMapView(Context context, AttributeSet attrs) {
    super(context, attrs);
    initialize(context);
  }

  @TargetApi(Build.VERSION_CODES.HONEYCOMB)
  public OpenNetworkMapView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private void initialize(Context context) {
    ...
    LayoutInflater.from(context).inflate(R.layout.opennetwork_map_view, this, true);
  ...
  public ListenableFuture<Bitmap> display(final OpenNetworkPlace place) {

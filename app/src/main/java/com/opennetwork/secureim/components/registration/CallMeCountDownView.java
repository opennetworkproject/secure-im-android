package com.opennetwork.secureim.components.registration;
...
public class CallMeCountDownView extends RelativeLayout {
  ...
  public void setCallEnabled() {
    setVisibility(View.VISIBLE);
    this.phone.setColorFilter(new PorterDuffColorFilter(getResources().getColor(R.color.opennetwork_primary), PorterDuff.Mode.SRC_IN));
    this.callMeText.setTextColor(getResources().getColor(R.color.opennetwork_primary));

...
import com.opennetwork.secureim.components.webrtc.WebRtcAnswerDeclineButton;
import com.opennetwork.secureim.components.webrtc.WebRtcCallControls;
import com.opennetwork.secureim.components.webrtc.WebRtcCallScreen;
...
public class WebRtcCallActivity extends Activity {
  ...
  public  static final int BUSY_opennetwork_DELAY_FINISH = 5500;
  ...
  private OpenNetworkServiceNetworkAccess networkAccess;
  ...
  private void initializeResources() {
    ...
    networkAccess = new OpenNetworkServiceNetworkAccess(this);
  }
  ...
  private void handleAnswerCall() {
    ...
    if (event != null) {
      Permissions.with(this)
                 ...
                 .ifNecessary()
                 .withRationaleDialog(getString(R.string.WebRtcCallActivity_to_answer_the_call_from_s_give_opennetwork_access_to_your_microphone, event.getRecipient().toShortString()),
                                      R.drawable.ic_mic_white_48dp, R.drawable.ic_videocam_white_48dp)
                 .withPermanentDenialDialog(getString(R.string.WebRtcCallActivity_opennetwork_requires_microphone_and_camera_permissions_in_order_to_make_or_receive_calls))
                 .onAllGranted(() -> {
  ...
  private void handleCallBusy(@NonNull WebRtcViewModel event) {
    ...
    delayedFinish(BUSY_opennetwork_DELAY_FINISH);
  }
    ...
    callScreen.setAcceptIdentityListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        synchronized (SESSION_LOCK) {
          ...
          identityKeyStore.saveIdentity(new OpenNetworkProtocolAddress(recipient.getAddress().serialize(), 1), theirIdentity, true);
        }

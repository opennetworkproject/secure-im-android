...
public class CallNotificationBuilder {
  ...
  public static Notification getCallInProgressNotification(Context context, int type, Recipient recipient) {
    ...
    if (type == TYPE_INCOMING_CONNECTING) {
      ...
      builder.setContentText(context.getString(R.string.NotificationBarManager__incoming_opennetwork_call));
      ...
      builder.setContentText(context.getString(R.string.NotificationBarManager__establishing_opennetwork_call));
      ...
      builder.setContentText(context.getString(R.string.NotificationBarManager_opennetwork_call_in_progress));

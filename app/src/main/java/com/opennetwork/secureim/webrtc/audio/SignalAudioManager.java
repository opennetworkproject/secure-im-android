package com.opennetwork.secureim.webrtc.audio;
...
public class OpenNetworkAudioManager {

  private static final String TAG = OpenNetworkAudioManager.class.getSimpleName();
  ...
  public OpenNetworkAudioManager(@NonNull Context context) {

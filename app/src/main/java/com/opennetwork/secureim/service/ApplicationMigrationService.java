...
import com.opennetwork.secureim.database.SmsMigrator;
import com.opennetwork.secureim.database.SmsMigrator.ProgressDescription;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "com.opennetwork.securesms.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "com.opennetwork.securesms.ApplicationMigrationService.COMPLETED";

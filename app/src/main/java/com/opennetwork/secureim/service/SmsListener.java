...
import com.opennetwork.secureim.jobs.SmsReceiveJob;
...
public class SmsListener extends BroadcastReceiver {
  ...
  private static final Pattern CHALLENGE_PATTERN = Pattern.compile(".*Your (OpenNetwork|TextSecure) verification code:? ([0-9]{3,4})-([0-9]{3,4}).*", Pattern.DOTALL);

...
public class UpdateApkReadyListener extends BroadcastReceiver {
  ...
  private void displayInstallNotification(Context context, Uri uri) {
    ...
    Notification notification = new NotificationCompat.Builder(context)
        .setOngoing(true)
        .setContentTitle(context.getString(R.string.UpdateApkReadyListener_OpenNetwork_update))
        .setContentText(context.getString(R.string.UpdateApkReadyListener_a_new_version_of_opennetwork_is_available_tap_to_update))
